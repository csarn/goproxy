...
func (proxy *ProxyHttpServer) NewConnectDialToNTLMProxy(https_proxy string) func(network, addr string) (net.Conn, error) {
	return proxy.NewConnectDialToNTLMProxyWithHandler(https_proxy, nil)
}
